...
Фоновое обновление списков происходит каждые 15 секунд, состояние выбранного процесса —
каждые 10 секунд: в первую минуту это максимум 24 authenticated-user запроса при
стандартном лимите 30. Новый список отменяет предыдущий запрос, а устаревший ответ
игнорируется. Принятая API команда
