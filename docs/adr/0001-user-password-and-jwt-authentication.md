...
- Require a signing key of at least 32 UTF-8 bytes from configuration. The repository
  contains issuer/audience defaults but no signing key.
...
- Configuration validation rejects missing/short signing keys at startup.
