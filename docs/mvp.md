...
повтора. До #29 Agent удерживает только одну `Claimed`/`Recovery` команду и не забирает
следующую; выполнение процесса и transition намеренно ещё не выполняются.
