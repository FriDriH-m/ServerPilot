...
internal sealed class AgentConfiguration : IEntityTypeConfiguration<Agent>
{
    ...
    internal const string UserRegisteredAtIndexName = "ix_agents_user_id_registered_at";
    ...
    public void Configure(EntityTypeBuilder<Agent> builder)
    {
        ...
        builder.HasIndex(agent => new { agent.UserId, agent.RegisteredAt })
            .HasDatabaseName(UserRegisteredAtIndexName);
